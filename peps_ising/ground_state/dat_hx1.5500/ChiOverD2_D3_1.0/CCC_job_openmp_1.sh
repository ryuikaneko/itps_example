...
#cp ../min_D2/output_Tn_*.npz input_Tn.npz
cp ../min_D3/output_Tn_*.npz input_Tn.npz
...
ipad=000000
  ...
  ${python} ${prog} \
  -i ${init} -hx ${hx} -ts ${ts} -ss 0 -sf 0 --second_ST \
...
#  # simple update
#  ${python} ${prog} \
#  -i -1 -hx ${hx} -ts ${ts} -ss ${steps} -sf 0 --second_ST \
#  > output_phys_quant_${ipad}
#  cp output_Tn.npz output_Tn_${ipad}.npz
#  mv output_Tn.npz input_Tn.npz
##
